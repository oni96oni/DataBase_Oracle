...
SELECT * FROM DEPARTMENTS WHERE DEPARTMENT_NAME IN 'IT';
...
SELECT STREET_ADDRESS,POSTAL_CODE,CITY FROM LOCATIONS WHERE COUNTRY_ID ='US';
...
SELECT SALARY, COMMISSION_PCT, SALARY * (1 + COMMISSION_PCT) AS TOTAL_SALARY --★알아서 테이블이 생긴다!
FROM EMPLOYEES 
WHERE  COMMISSION_PCT 
IS NOT NULL AND SALARY >=10000;
